...
configPageView configModel =
    div [ id "config-section" ]
        ...
        , div [ class "change-section" ]
            ...
            , br [] []
            , input [ placeholder "New Username", onInput <| Config << SetConfigUsernameField, value configModel.username ] []
            , br [] []
        ...
        , div [ class "change-section" ]
            ...
            , br [] []
            , input [ placeholder "Old Password", type_ "password", onInput <| Config << SetConfigPasswordField, value configModel.password ] []
            , br [] []
            , input [ placeholder "New Password", type_ "password", onInput <| Config << SetConfigNewPasswordField, value configModel.newPassword ] []
            , br [] []
            , input [ placeholder "New Password (Repeat)", type_ "password", onInput <| Config << SetConfigNewPassword2Field, value configModel.newPassword2 ] []
            , br [] []
            , button [ type_ "submit", onClick <| Config ChangePasswordRequest, disabled (configModel.password == "" || configModel.newPassword == "" || configModel.newPassword /= configModel.newPassword2) ] [ text "Change" ]
            ]
        ]
